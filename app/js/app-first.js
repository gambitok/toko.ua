...
$(document).ready(function() {
    ...
    // Main Banner
    $(".carousel").carousel({ interval: 122000 });

    // Catalog Filters
    let input_price = $("#filter-price"),
        input_delivery = $("#filter-delivery");
    ...
    // Adaptive navigation
    $(".bar").bigSlide({ menu: ('#menu') });

    // Adaptive Catalog navigation
    $(".bar-catalog").bigSlide({ menu: ('#menu-catalog') });

    // Adaptive Catalog navigation
    $(".bar-menu").bigSlide({ menu: ('#bar-menu') });
