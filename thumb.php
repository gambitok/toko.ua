<?php
error_reporting(0);
@ini_set('display_errors', false);//if ($_SERVER['REMOTE_ADDR']=="78.152.169.139"){error_reporting(E_ALL & ~E_NOTICE & ~E_DEPRECATED);@ini_set('display_errors', true);}
...
//	$type=3;
	...
	$black = imagecolorallocate($res, 0, 0, 0);ImagePNG($res,$prod_img_thumb,0,100);
	ImageDestroy ($res);
}
