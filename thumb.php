...
//	$size_logo = $size * 0.80;
//	$max_height_logo = $max_height * 0.80;
//	$sizes = getimagesize($img_src);
//	$aspect_ratio = $sizes[0] / $sizes[1];
//	$type = $sizes[2];
//	header("Content-Type:image/$type");
//	if ($sizes[0] >= $sizes[1]) {
//		if ($sizes[0] <= $size_logo) {
//		    $new_width = $sizes[0];
//		    $new_height = $sizes[1];
//		} else {
//		    $new_width = $size_logo;
...
//	}
//	if ($sizes[0] < $sizes[1]) {
//		if ($sizes[1] <= $size_logo) {
//		    $new_width = $sizes[0];
//		    $new_height = $sizes[1];
//		} else {
//		    $new_height = $size_logo;
//		    $new_width = abs($new_height * $aspect_ratio);
//		}
//	}
//	if ($new_height > $size_logo) {
//	    $new_height = $size_logo;
//	    $new_width = abs($new_height * $aspect_ratio);
//	}
//	if ($max_height_logo != "" and $max_height_logo < $new_height) {
//	    $new_height = $max_height_logo;
//	    $new_width = abs($new_height * $aspect_ratio);
//	}
//
//	if ($type == 1) { $srcimg = ImageCreateFromGIF($img_src); }
...
//if ($_GET["logo"] != "") {
//    create_logo_thumb($_GET["logo"], $_GET["size"], $_GET["max_height"], $_GET["op"]);
//}
