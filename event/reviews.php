...
if ($link === "") {
    ...
    $title = str_replace("{h1_text}", "{review_state_cap}", $catalogue->replaceLang("{site_reviews}"));
}
...
elseif ($link === "state") {
    ...
    $title = str_replace("{h1_text}", ($dataReview["site_title"] === "") ? $dataReview["title"] : $dataReview["site_title"], $catalogue->replaceLang("{site_reviews}"));
