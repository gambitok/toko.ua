...
//$group_id = $catalogue->getCatalogProductID($w);
...
//    $form=str_replace("{select_group}", $catalogue->showCatalogProducts(), $form);
...
//        list($list, $max_page) = $pattern->showCatalogProductsList($group_id, $page, $link);
        $content=str_replace("{main_window}", $list, $content);
